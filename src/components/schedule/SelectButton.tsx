...
const SelectButton = ({index, group, type, schedule, classData, handleClick, style={}}:{index:number,group:number,type:'class'|'soudan'|'provide'|'goOut'|'vocal'|'dance'|'visual'|'rest'|'hajime_m'|'hif',schedule:Array<number>,classData:any,handleClick:Function, style?:React.CSSProperties}) => {
    ...
    const types = {
        ...
        hif_vocal: {text:"Vo",color:"#f24b9d",variant:"h6",pos:[11,15]},
        hif_dance: {text:"Da",color:"#23cfeb",variant:"h6",pos:[11,15]},
        hif_visual: {text:"Vi",color:"#fcb531",variant:"h6",pos:[14,15]},

        hajime_m: {text:"初",color:"#b59bcd",vaariant:"h6",pos:[14,16]},
        hif: {text:"H.I.F.",color:"#4175d4",vaariant:"h7",pos:[0,16]},
    }
    ...
    <>
        <div onClick={(e) => handleClick(e, group, index, type)} className='buttonWrapper'>
            ...
            >
                ...
                <Typography variant='h6' sx={{userSelect:"none",lineHeight:1,position:'absolute',left:types[type].pos[0],top:types[type].pos[1],textAlign:'center'}}>
                    {types[type].text}
                </Typography>
            </Box>
        </div>
